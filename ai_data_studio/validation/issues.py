...
class ValidationIssueCode(StrEnum):
    CANONICAL_DOCUMENT_MISSING = "CANONICAL_DOCUMENT_MISSING"
    CANONICAL_DOCUMENT_MAPPING_MISMATCH = "CANONICAL_DOCUMENT_MAPPING_MISMATCH"
    ...
    WORKING_BATCH_MISSING = "WORKING_BATCH_MISSING"
    WORKING_BATCH_MAPPING_MISMATCH = "WORKING_BATCH_MAPPING_MISMATCH"
    DATASET_MULTIPLE_GUIDELINE_VERSIONS = "DATASET_MULTIPLE_GUIDELINE_VERSIONS"
